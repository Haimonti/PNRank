...
public class AnnotateTitles {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            BufferedWriter outSigMap = new BufferedWriter(new FileWriter("/Users/jayashree/Documents/Output_PNRank/data/Signature_feature.csv"));
            ...
            BufferedWriter outTitleMap = new BufferedWriter(new FileWriter("/Users/jayashree/Documents/Output_PNRank/data/TopicFinalOutput/PersonTitleMap.txt"));
            ...
            outSigMap.write("Name of Person" +","+ "Titles"+","+"Wikipedia\n");
                        ...
                        if(!tempList.contains(keyTitle.toLowerCase())){
                            ...
                            if(list_titles.contains(element.toString())){
                                if(list_titles_wiki.contains(element.toString())) {
                                    outSigMap.write(keyTitle + "," + "1"+","+" 1 \n");
                                }else{
                                    outSigMap.write(keyTitle + "," + "1"+","+" 0 \n");
                                }
                            }else if(list_titles_wiki.contains(element.toString())){
                                outSigMap.write(keyTitle+","+"0"+","+"1 \n" );
                            }else{
                                outSigMap.write(keyTitle+","+"0"+","+"0 \n");
                            }
                        }
